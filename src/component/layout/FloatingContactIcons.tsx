...
const FloatingContactIcons = () => {
  ...
  // TODO: Replace with your actual contact number
  const phoneNumber = "9265484628"; 
  const whatsappMessage = "Hello, I am interested in joining AstroCareer.";
  ...
  return (
    <div className="fixed bottom-6 right-6 flex flex-col gap-4 z-50">
      ...
      {isVisible && (
        <button
          onClick={scrollToTop}
          className="bg-amber-500 hover:bg-amber-600 text-white p-3 rounded-full shadow-lg transition-transform hover:scale-110 flex items-center justify-center"
      ...
      <a
        ...
        className="bg-[#25D366] hover:bg-[#20bd5a] text-white p-3 rounded-full shadow-lg transition-transform hover:scale-110 flex items-center justify-center"
